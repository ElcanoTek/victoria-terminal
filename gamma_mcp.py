...
async def generate_presentation(
    ...
    additional_instructions: str = (
        ...
        "For Campaign Wrap-Up Protocol presentations, follow this specific structure: "
        "1) Title Slide: '[Client Name] — Programmatic Campaign Performance Report' with date range "
        "2) Executive Summary: Display four key metrics prominently at top (Total Spend, Impressions, Total Clicks, Overall CTR) with descriptive subtitles, followed by highlights and recommendations in a single cohesive paragraph "
        "3) Data Sources & Methodology: Four-section breakdown with clear numbered sections "
        "4) Platform Economics Overview: Horizontal bar chart showing platform performance "
        "5) Daily Performance Trends: Line chart with contextual text and callout box "
        "6) Strategy Performance Analysis: Horizontal bar chart for strategy comparison "
        "7) Geographic Performance Leaders: Top 3 locations with numbered highlights "
        "8) Device & Browser Insights: Two-column layout with bullet points "
        "9) Strategic Recommendations: Three key recommendations with efficiency targets "
        "10) Thank You Slide: Simple closing with Elcano branding. "
